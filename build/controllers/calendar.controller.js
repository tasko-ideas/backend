...
const CalendarController = {
    createCalendarItem: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
    ...
    getAllCalendar: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const user = yield user_model_1.default.findOne({ _id: req.user });
            if (!user) {
                return res
    ...
    getCalendarByYear: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const user = yield user_model_1.default.findOne({ _id: req.user });
            if (!user) {
                return res
    ...
    getCalendarByMonth: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const user = yield user_model_1.default.findOne({ _id: req.user });
            if (!user) {
                return res
    ...
    getCalendarByDay: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const user = yield user_model_1.default.findOne({ _id: req.user });
            if (!user) {
                return res
